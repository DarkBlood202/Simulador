...
if __name__ == "__main__":
    ...
    textinput = TextInput(max_string_length=20)

    screen = pygame.display.set_mode((800, 600))
    textbox = pygame.Surface((400,30))

    clock = pygame.time.Clock()

    while True:
        screen.fill((225, 225, 225))
        textbox.fill((0,255,0))
        ...
        # Blit textbox to surface
        textbox.blit(textinput.get_surface(), (5, 3))
